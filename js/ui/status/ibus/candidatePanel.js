...
const Handle = imports.ui.status.ibus.handle;
const PangoAttrList = imports.ui.status.ibus.pangoAttrList.PangoAttrList;

const _ = imports.ui.status.ibus.common._;
const ORIENTATION_HORIZONTAL = imports.ui.status.ibus.common.ORIENTATION_HORIZONTAL;
const ORIENTATION_VERTICAL   = imports.ui.status.ibus.common.ORIENTATION_VERTICAL;
